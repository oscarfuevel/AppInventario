...
public class ReportProveedores {
    ...
    public static void reporte() {
        ...
        try {
            ...
            String[] cabecera = new String[]{"Id", "Nombre", "Ciudad", "Dirección", "Teléfono", "Correo"};
            ...
            ps = conn.prepareStatement("SELECT idproveedor, nombre, cod_ciudad, direccion, telefono,correo FROM proveedor");
            rs = ps.executeQuery();
            ...
            sheet.setZoom(150);
            String fileName = "Proveedores Registrados";
